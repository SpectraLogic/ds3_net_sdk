...
longIntegration: build
	mono ./packages/NUnit.ConsoleRunner.3.7.0/tools/nunit3-console.exe ./LongRunningIntegrationTestDs3/bin/Release/LongRunningIntegrationTestDs3.dll
integration: build
	mono ./packages/NUnit.ConsoleRunner.3.7.0/tools/nunit3-console.exe ./IntegrationTestDS3/bin/Release/IntegrationTestDS3.dll
unit: build
