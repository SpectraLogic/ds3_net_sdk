...
namespace TestDs3
{
    ...
    internal interface IMockNetworkWithReturn
    {
    ...
    internal class MockNetwork : INetwork, IMockNetworkWithExpectation, IMockNetworkWithReturn
    {
        ...
        IDs3Client IMockNetworkWithReturn.AsClient => new Ds3Client(this);
        ...
        public int CopyBufferSize => Network.DefaultCopyBufferSize;
