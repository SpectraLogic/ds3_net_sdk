...
namespace Ds3.Calls
{
    public class GetPhysicalPlacementForObjectsWithFullDetailsSpectraS3Request : Ds3Request
    {
        ...
        public GetPhysicalPlacementForObjectsWithFullDetailsSpectraS3Request(string bucketName, IEnumerable<Ds3Object> fullObjects, IEnumerable<Ds3PartialObject> partialObjects)
        {
        ...
        public GetPhysicalPlacementForObjectsWithFullDetailsSpectraS3Request(string bucketName, IEnumerable<Ds3Object> ds3Objects)
            : this(bucketName, ds3Objects, Enumerable.Empty<Ds3PartialObject>())
        {
        }

        public GetPhysicalPlacementForObjectsWithFullDetailsSpectraS3Request(string bucketName, IEnumerable<string> objectNames)
