...
namespace Ds3.Calls
{
    public class MarkSuspectBlobS3TargetsAsDegradedSpectraS3Request : AbstractIdsPayloadRequest
    {
        ...
        public MarkSuspectBlobS3TargetsAsDegradedSpectraS3Request WithForce(bool? force)
        {
            this._force = force;
            if (force != null)
            {
