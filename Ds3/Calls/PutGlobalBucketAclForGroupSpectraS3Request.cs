...
namespace Ds3.Calls
{
    public class PutGlobalBucketAclForGroupSpectraS3Request : Ds3Request
    {
        ...
        public PutGlobalBucketAclForGroupSpectraS3Request(Guid groupId, BucketAclPermission permission)
        {
