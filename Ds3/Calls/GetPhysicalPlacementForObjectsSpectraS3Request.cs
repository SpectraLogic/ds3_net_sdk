...
namespace Ds3.Calls
{
    public class GetPhysicalPlacementForObjectsSpectraS3Request : Ds3Request
    {
        ...
        public GetPhysicalPlacementForObjectsSpectraS3Request WithStorageDomainId(Guid? storageDomainId)
        {
        ...
        public GetPhysicalPlacementForObjectsSpectraS3Request WithStorageDomainId(string storageDomainId)
        {
