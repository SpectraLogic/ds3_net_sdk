...
namespace Ds3.Calls
{
    public class PutTapePartitionFailureNotificationRegistrationSpectraS3Request : Ds3Request
    {
        ...
        public PutTapePartitionFailureNotificationRegistrationSpectraS3Request WithFormat(HttpResponseFormatType? format)
        {
            this._format = format;
            if (format != null)
            {
        ...
        public PutTapePartitionFailureNotificationRegistrationSpectraS3Request WithNamingConvention(NamingConventionType? namingConvention)
        {
        ...
        public PutTapePartitionFailureNotificationRegistrationSpectraS3Request WithNotificationHttpMethod(RequestType? notificationHttpMethod)
        {
        ...
        public PutTapePartitionFailureNotificationRegistrationSpectraS3Request(string notificationEndPoint)
        {
