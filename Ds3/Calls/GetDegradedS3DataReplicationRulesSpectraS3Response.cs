...
namespace Ds3.Calls
{
    public class GetDegradedS3DataReplicationRulesSpectraS3Response
    {
        ...
        public GetDegradedS3DataReplicationRulesSpectraS3Response(S3DataReplicationRuleList responsePayload, int? pagingTruncated, int? pagingTotalResultCount)
        {
