...
namespace Ds3.Calls
{
    public class PutS3TargetFailureNotificationRegistrationSpectraS3Request : Ds3Request
    {
        ...
        public PutS3TargetFailureNotificationRegistrationSpectraS3Request WithFormat(HttpResponseFormatType? format)
        {
            this._format = format;
            if (format != null)
            {
        ...
        public PutS3TargetFailureNotificationRegistrationSpectraS3Request WithNamingConvention(NamingConventionType? namingConvention)
        {
        ...
        public PutS3TargetFailureNotificationRegistrationSpectraS3Request WithNotificationHttpMethod(RequestType? notificationHttpMethod)
        {
        ...
        public PutS3TargetFailureNotificationRegistrationSpectraS3Request(string notificationEndPoint)
        {
