...
namespace Ds3.Calls
{
    public class MarkSuspectBlobTapesAsDegradedSpectraS3Request : AbstractIdsPayloadRequest
    {
        ...
        public MarkSuspectBlobTapesAsDegradedSpectraS3Request WithForce(bool? force)
        {
            this._force = force;
            if (force != null)
            {
