...
namespace Ds3.Calls
{
    public class DeleteAzureDataReplicationRuleSpectraS3Request : Ds3Request
    {
        ...
        public DeleteAzureDataReplicationRuleSpectraS3Request(string azureDataReplicationRule)
        {
