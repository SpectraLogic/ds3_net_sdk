...
namespace Ds3.Calls
{
    public class PutAzureTargetReadPreferenceSpectraS3Request : Ds3Request
    {
        ...
        public PutAzureTargetReadPreferenceSpectraS3Request(Guid bucketId, TargetReadPreferenceType readPreference, Guid targetId)
        {
