...
namespace Ds3.Calls
{
    public class GetS3DataReplicationRulesSpectraS3Request : Ds3Request
    {
        ...
        public GetS3DataReplicationRulesSpectraS3Request WithDataPolicyId(Guid? dataPolicyId)
        {
        ...
        public GetS3DataReplicationRulesSpectraS3Request WithDataPolicyId(string dataPolicyId)
        {
        ...
        public GetS3DataReplicationRulesSpectraS3Request WithInitialDataPlacement(S3InitialDataPlacementPolicy? initialDataPlacement)
        {
        ...
        public GetS3DataReplicationRulesSpectraS3Request WithLastPage(bool? lastPage)
        {
        ...
        public GetS3DataReplicationRulesSpectraS3Request WithPageLength(int? pageLength)
        {
        ...
        public GetS3DataReplicationRulesSpectraS3Request WithPageOffset(int? pageOffset)
        {
        ...
        public GetS3DataReplicationRulesSpectraS3Request WithPageStartMarker(Guid? pageStartMarker)
        {
        ...
        public GetS3DataReplicationRulesSpectraS3Request WithPageStartMarker(string pageStartMarker)
        {
        ...
        public GetS3DataReplicationRulesSpectraS3Request WithReplicateDeletes(bool? replicateDeletes)
        {
        ...
        public GetS3DataReplicationRulesSpectraS3Request WithState(DataPlacementRuleState? state)
        {
            this._state = state;
            if (state != null)
            {
        ...
        public GetS3DataReplicationRulesSpectraS3Request WithTargetId(Guid? targetId)
        {
        ...
        public GetS3DataReplicationRulesSpectraS3Request WithTargetId(string targetId)
        {
        ...
        public GetS3DataReplicationRulesSpectraS3Request WithType(DataReplicationRuleType? type)
        {
            this._type = type;
            if (type != null)
            {
