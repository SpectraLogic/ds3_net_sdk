...
namespace Ds3.Calls
{
    public class DeleteDataPersistenceRuleSpectraS3Request : Ds3Request
    {
        ...
        public DeleteDataPersistenceRuleSpectraS3Request(Guid dataPersistenceRuleId)
        {
        ...
        public DeleteDataPersistenceRuleSpectraS3Request(string dataPersistenceRuleId)
        {
