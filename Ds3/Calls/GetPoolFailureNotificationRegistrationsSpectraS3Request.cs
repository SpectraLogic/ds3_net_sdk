...
namespace Ds3.Calls
{
    public class GetPoolFailureNotificationRegistrationsSpectraS3Request : Ds3Request
    {
        ...
        public GetPoolFailureNotificationRegistrationsSpectraS3Request WithPageStartMarker(string pageStartMarker)
        {
        ...
        public GetPoolFailureNotificationRegistrationsSpectraS3Request WithUserId(string userId)
        {
            this._userId = userId;
            if (userId != null)
            {
