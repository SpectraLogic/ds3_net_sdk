...
namespace Ds3.Calls
{
    public class TruncateAllActiveJobsSpectraS3Request : Ds3Request
    {
        ...
        public TruncateAllActiveJobsSpectraS3Request WithBucketId(Guid? bucketId)
        {
        ...
        public TruncateAllActiveJobsSpectraS3Request WithBucketId(string bucketId)
        {
        ...
        public TruncateAllActiveJobsSpectraS3Request WithRequestType(JobRequestType? requestType)
        {
