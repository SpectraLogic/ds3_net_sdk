...
namespace Ds3.Calls
{
    public class PutStorageDomainFailureNotificationRegistrationSpectraS3Request : Ds3Request
    {
        ...
        public PutStorageDomainFailureNotificationRegistrationSpectraS3Request WithFormat(HttpResponseFormatType? format)
        {
            this._format = format;
            if (format != null)
            {
        ...
        public PutStorageDomainFailureNotificationRegistrationSpectraS3Request WithNamingConvention(NamingConventionType? namingConvention)
        {
        ...
        public PutStorageDomainFailureNotificationRegistrationSpectraS3Request WithNotificationHttpMethod(RequestType? notificationHttpMethod)
        {
        ...
        public PutStorageDomainFailureNotificationRegistrationSpectraS3Request(string notificationEndPoint)
        {
