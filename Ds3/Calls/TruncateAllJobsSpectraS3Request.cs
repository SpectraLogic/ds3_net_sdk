...
namespace Ds3.Calls
{
    public class TruncateAllJobsSpectraS3Request : Ds3Request
    {
        ...
        public TruncateAllJobsSpectraS3Request WithBucketId(Guid? bucketId)
        {
        ...
        public TruncateAllJobsSpectraS3Request WithBucketId(string bucketId)
        {
        ...
        public TruncateAllJobsSpectraS3Request WithRequestType(JobRequestType? requestType)
        {
