...
namespace Ds3.Calls
{
    public class MarkSuspectBlobAzureTargetsAsDegradedSpectraS3Request : AbstractIdsPayloadRequest
    {
        ...
        public MarkSuspectBlobAzureTargetsAsDegradedSpectraS3Request WithForce(bool? force)
        {
            this._force = force;
            if (force != null)
            {
