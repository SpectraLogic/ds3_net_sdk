...
namespace Ds3.Calls
{
    public class PutAzureTargetFailureNotificationRegistrationSpectraS3Request : Ds3Request
    {
        ...
        public PutAzureTargetFailureNotificationRegistrationSpectraS3Request WithFormat(HttpResponseFormatType? format)
        {
            this._format = format;
            if (format != null)
            {
        ...
        public PutAzureTargetFailureNotificationRegistrationSpectraS3Request WithNamingConvention(NamingConventionType? namingConvention)
        {
        ...
        public PutAzureTargetFailureNotificationRegistrationSpectraS3Request WithNotificationHttpMethod(RequestType? notificationHttpMethod)
        {
        ...
        public PutAzureTargetFailureNotificationRegistrationSpectraS3Request(string notificationEndPoint)
        {
