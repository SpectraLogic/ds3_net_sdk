...
{
    internal class ModifyJobSpectraS3ResponseParser : IResponseParser<ModifyJobSpectraS3Request, ModifyJobSpectraS3Response>
    {
        public ModifyJobSpectraS3Response Parse(ModifyJobSpectraS3Request request, IWebResponse response)
        {
            using (response)
            {
                ...
                switch (response.StatusCode)
                {
                    case (HttpStatusCode)200:
                        ...
                        {
                            return new ModifyJobSpectraS3Response(
