    ...
    public class ModelParsers
    {
        ...
        public static DataPathBackend ParseDataPathBackend(XElement element)
        {
            return new DataPathBackend
            {
                ...
                IomCacheLimitationPercent = ParseDouble(element.Element("IomCacheLimitationPercent")),
                IomEnabled = ParseBool(element.Element("IomEnabled")),
                LastHeartbeat = ParseDateTime(element.Element("LastHeartbeat")),
                MaxAggregatedBlobsPerChunk = ParseInt(element.Element("MaxAggregatedBlobsPerChunk")),
